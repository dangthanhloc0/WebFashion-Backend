...
namespace BACKENDEMO.Migrations
{
    ...
    [Migration("20240925041351_update ordertails")]
    partial class updateordertails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "913bcbbc-c19d-40df-844a-ab7922450da0",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "0e14da5f-c25c-4071-acfd-c902b6222aca",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BACKENDEMO.Entity.Product", b =>
                {
                    b.HasOne("BACKENDEMO.Entity.Category", "category")
                        .WithMany("products")
